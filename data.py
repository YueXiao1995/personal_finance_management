...
class DataManager():
    def __init__(self):
        ...
        self.daily_spend = {"2020-02-01": [317.5],
                           ...
                           "2020-08-24": [6.8, 17],
                           "2020-08-25": [6.8],
                           "2020-08-26": [14, 124.75, 20, 28, 22.5],
                           "2020-08-27": [6.8],
                           "2020-08-28": [23.3, 11, 3, 3],
                           "2020-08-29": [17.5, 60, 80, 177, 134.95],
                           "2020-08-30": [16, 3, 4, 25, 100, 10, 3, 4, 15, 6, 80],

                           "2020-08-31": [4.5],
                            # ========================================================
                            "2020-09-01": [58, 3.5],
                            "2020-09-02": [100, 14, 4.5, 14, 158, 10, 33.57],
                            "2020-09-03": [4, 19],
                            "2020-09-04": [16, 36, 45, 14, 10.6],
                            "2020-09-05": [19, 42.5, 4.5, 70],
                            "2020-09-06": [7.2, 149.7, 11, 14, 4.5, 49.9, 22.9],
                            "2020-09-07": [8, 14, 25.44],
                            "2020-09-08": [7.2, 8, 169, 6.4, 3.5],
                            "2020-09-09": [409, 7.2, 200],
                            "2020-09-10": [10, 5],
                            "2020-09-11": [7.2, 5],
                            "2020-09-12": [71.1, 10, 25.9, 109.3, 25, 38.54],
                            "2020-09-13": [6.8, 12.4, 14],
                            "2020-09-14": [14, 1],
                            "2020-09-15": [],
                            "2020-09-16": [4.5],
                            "2020-09-17": [3, 59],
                            "2020-09-18": [50, 3.5],
                            "2020-09-19": [49.19, 23.9, 209, 1.7],
                            "2020-09-20": [10.83, 6.5, 18.6],
                            "2020-09-21": []
                       }
        ...
        self.spend_by_categoty = {
            '2020-08': {
                        'food': [1629.44],
                         ...
                         'commodity': [581.7],
                         'education': [],
                         'entertainment': [882.48],
                         'medical': [34.5],
                         'gift': [1959.8],
                         'others': [237.62]
                         },
            "2020-09": {
                        'food': [565.64, 10, 25.9, 109.3, 25, 6.8, 12.4, 14, 14, 4.5, 3, 59, 3.5, 209, 1.7, 6.5, 18.6],
                        'clothes': [],
                        'rent': [3430],
                        'transportation': [100, 158, 169, 5, 50],
                        'commodity': [149.7, 49.9, 23.9],
                        'education': [71.1, 38.54],
                        'entertainment': [134.95, 33.57],
                        'medical': [],
                        'gift': [16, 36, 409, 49.19, 10.83],
                        'others': [58, 45, 4.5, 11, 10, 1]
                        }
        }
        ...
        self.total_assets = {
            ...
            '2020-09': {'deposit': 3031.88 + 233.78 + 250 + 1200, 'stock': 0, 'fund': 17121.57 + 804.36, 'debt': -2363.8 - 583.79 - 69.3, 'bond': 0, 'noble metals': 6.18, 'real estate': 0}
        }

    def get_monthly_income(self):
        return self.monthly_income

    def get_monthly_income_by_month(self, month):
        return self.monthly_income[month]
